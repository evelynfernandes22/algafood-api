...
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro, data_cadastro, data_atualizacao) values ('Xing Ling', 10, 1,true, 1, 86000-000, 'Rua das Flores', '500', 'Centro', utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, data_cadastro, data_atualizacao) values ('Madre Mio Delivery', 9.50, 2, true, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, data_cadastro, data_atualizacao) values ('Cantina da Vovó', 3.90, 3, true, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, data_cadastro, data_atualizacao) values ('Bar do Tadeu', 2.10, 3, true, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, data_cadastro, data_atualizacao) values ('Muchachados Taqueria', 8, 4, true, utc_timestamp, utc_timestamp);
insert into restaurante (nome, taxa_frete, cozinha_id, ativo, data_cadastro, data_atualizacao) values('Dachô', 11, 5, true, utc_timestamp, utc_timestamp); 
