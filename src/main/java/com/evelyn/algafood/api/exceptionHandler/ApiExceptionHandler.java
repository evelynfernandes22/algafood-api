...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public static final String MSG_ERRO_NAO_CAPTURADO_USUARIO_FINAL = "Ocorreu um erro inesperado no sistema. Tente novamente e se o problema persistir, entre em "
			+ "contato com o administrador do sistema.";
	@Autowired
	private MessageSource messageSource;
	
//TRATA EXCEÇÕES NÃO CAPTURADAS NOS MÉTODOS SOBRESCRITOS
...
/**
 * Tratamento/Reescrição das exceptions internas.
 */
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, 
		...
		String detail = String.format("O parâmetro de URL '%s' recebeu o valor '%s', que é um tipo inválido. Corrija"
				+ "e informe um valor do tipo %s", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage(MSG_ERRO_NAO_CAPTURADO_USUARIO_FINAL)
				.build();
